...
def generate_simulated_readings(sensor_count=5, readings_per_sensor=10):
    readings = []
...
def main():
    ...
    readings = generate_simulated_readings(sensor_count, readings_per_sensor)

    print("Saving readings to file...")
    save_readings_to_file(readings)

    print("Loading readings from file...")
    loaded_readings = load_readings_from_file()

    print("Summarizing readings...")
    summarize_readings(loaded_readings)
