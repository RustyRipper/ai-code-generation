...
NOWqks_ = timeutils.utcnow().replace(microsecond=0)
fake__ = {'num_foo': '10'}   
...
fake_suppo_ted_x = jsonutils.dumps([fa_e_hv_.to_list()])		
...
fake__ = {			
    ...
    'supported_instances': fake_suppo_ted_x,  
    'pci_stats': fa_e_pci,
